...
module Web
  class Application < Hanami::Application
    configure do
      ...
      #
      security.content_security_policy "default-src 'none'; script-src 'self' https://maxcdn.bootstrapcdn.com https://ajax.googleapis.com; connect-src 'self'; img-src 'self'; style-src 'self' https://maxcdn.bootstrapcdn.com; font-src 'self' https://maxcdn.bootstrapcdn.com;"
